      ...
      <main class="bg-light principal py-auto mx-auto">
            <content class="container-fluid py-5 row col-11 mx-auto" style="min-height: auto;">
                <div class="jumbotron col-12 bg-white shadow-sm">
                    ...
                    <a class="btn btn-danger btn-lg" href="funcionalidades.php" role="button">Leia mais</a>
                </div>
                <div class="row mt-3">
                    <div class="col-md-4 mb-3 mb-md-0">
                      <div class="card border-white shadow-sm">
                        <div class="card-body">
                          ...
                          <a href="sobre.php" class="btn btn-danger">Leia mais</a>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <div class="col-md-4 mb-3 mb-md-0">
                      <div class="card border-white shadow-sm">
                        <div class="card-body">
                          ...
                          <a href="atualizacoes.php" class="btn btn-danger">Leia mais</a>
                        </div>
                      </div>
                    </div>
                </div>
