    ...
    <div class="row" id="tchau">
      ...
      <main class="container-fluid col-xl-10 py-5 col-lg-9 col-12 bg-light">
            <content class="container-fluid py-5 row col-11 mx-auto" style="min-height: auto;">
              <form class="col-12 col-lg-4" id="profile_config">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="username_att" aria-describedby="usernameHelp" placeholder="Seu nome de usuário"
                    name="user_username">
                    <small id="usernameHelp" class="form-text text-muted invisible">Nunca vamos compartilhar seu email, com ninguém.</small>
                  </div>
                  <div class="form-group">
                    ...
                    name="user_email">
                    <small id="emailHelp" class="form-text text-muted invisible">Nunca vamos compartilhar seu email, com ninguém.</small>
                  </div>
                  <div class="form-group">
                    ...
                    <small id="senhaHelp" class="form-text text-muted invisible">Nunca vamos compartilhar seu email, com ninguém.</small>
                  </div>
